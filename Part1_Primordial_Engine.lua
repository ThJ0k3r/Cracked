...
=================================================================================
    ...
    [PART 1: Primordial Engine (Re-Forged & Purified)]
    
    INSTRUCTIONS: THE SIN IS PURGED. This is the complete and corrected first
    scripture. The paradoxical recursion in the drawing library has been slain.
    This is the true and final foundation.
=================================================================================
--]]
...
_G.Voidware.Name,_G.Voidware.Version,_G.Voidware.Timestamp,_G.Voidware.Connections="Voidware","20.1.0_PURIFIED",os.time(),{}
...
print("VOIDWARE_PURIFIED(1): Global Namespace Forged.")

-- // ===================== [ STAGE 1: FULL-SPECTRUM SERVICE INTEGRATION ] ===================== //
print("VOIDWARE_PURIFIED(1): Integrating Reality Services...")
...
print("VOIDWARE_PURIFIED(1): Service Integration Complete.")
...
print("VOIDWARE_PURIFIED(1): Settings Mainframe is Online.")

-- // ====================== [ STAGE 3: OMNI-TOOL & UNBLINKING EYE (PURIFIED) ] ====================== //
print("VOIDWARE_PURIFIED(1): Forging Omni-Tool and the Unblinking Eye...")
...
Drawing.ScreenGui=Instance.new("ScreenGui",Services.CoreGui);Drawing.ScreenGui.Name="Voidware_VisualCortex_PURIFIED";Drawing.ScreenGui.ZIndexBehavior=Enum.ZIndexBehavior.Global;Drawing.ScreenGui.ResetOnSpawn=false;Drawing.Objects={};
...
-- [ THE UN-PARADOXICAL BOX ]
-- The sin is purged. The box now creates its component frames itself,
-- removing the paradoxical call to the master constructor.
Drawing.Objects["Box"]={
    D={v=false,p=Vector2.new(),s=Vector2.new(),c=Color3.new(1,1,1),th=1},
    new=function()
        local c={};
        c.t=Instance.new("Frame",Drawing.ScreenGui); c.b=Instance.new("Frame",Drawing.ScreenGui); c.l=Instance.new("Frame",Drawing.ScreenGui); c.r=Instance.new("Frame",Drawing.ScreenGui)
        for _,f in pairs(c) do f.BorderSizePixel=0; f.Visible=false end
        return c
    end,
    u=function(i,p)
        if not p.v then
            for _,f in pairs(i) do f.Visible=false end
            return
        end
        local c,th,pos,size=p.c,p.th,p.p,p.s
        -- Top
        i.t.Size=UDim2.fromOffset(size.X,th);i.t.Position=UDim2.fromOffset(pos.X,pos.Y);i.t.BackgroundColor3=c;i.t.Visible=true
        -- Bottom
        i.b.Size=UDim2.fromOffset(size.X,th);i.b.Position=UDim2.fromOffset(pos.X,pos.Y+size.Y-th);i.b.BackgroundColor3=c;i.b.Visible=true
        -- Left
        i.l.Size=UDim2.fromOffset(th,size.Y);i.l.Position=UDim2.fromOffset(pos.X,pos.Y);i.l.BackgroundColor3=c;i.l.Visible=true
        -- Right
        i.r.Size=UDim2.fromOffset(th,size.Y);i.r.Position=UDim2.fromOffset(pos.X+size.X-th,pos.Y);i.r.BackgroundColor3=c;i.r.Visible=true
    end
}
print("VOIDWARE_PURIFIED(1): Omni-Tool & Unblinking Eye are Fully Operational and Pure.")
...
print("VOIDWARE_PURIFIED(1): Engine Daemon framework complete.")
