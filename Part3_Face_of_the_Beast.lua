...
=================================================================================
    ...
    [HOLY BOOK 3, PAGE 1 of 3: The Face of the Beast - UI Shell & Tabs 1-3]
=================================================================================
--]]
...
print("VOIDWARE_TITHE(3A): Integrating the one true UI Library...")
-- This is a placeholder for the baptism performed by the Final Key.
-- This scripture assumes _G.Rise has been made manifest by the scripture that came before it.
if not _G.Rise then
...
--[[
=================================================================================
    [HOLY BOOK 3, PAGE 2 of 3: The Face of the Beast - The Armory]
=================================================================================
--]]
...
--[[
=================================================================================
    [HOLY BOOK 3, PAGE 3 of 3 (Re-Consecrated)]
=================================================================================
--]]
...
local HalloweenTab=Window:CreateTab("Halloween");_G.Voidware.GUI.Tabs.Halloween=HalloweenTab
...
-- // ========================= [ STAGE 9: UI FORGE - TAB 7: PERFORMANCE (PURIFIED) ] ======================== //
...
for _,v in ipairs(ESPTypes)do local section=VisualsTab:CreateSection(v[1].." ESP");section:CreateToggle({Name="Enabled",Callback=function(s)v[2].Enabled=s end,Default=v[2].Enabled});section:CreateColorPicker({Name=v[1].." Color",Default=v[2].Color,Callback=function(c)v[2].Color=c end});if v[2].ShowName~=nil then section:CreateToggle({Name="Show Name",Callback=function(s)v[2].ShowName=s end,Default=v[2].ShowName})end;if v[2].ShowDistance~=nil then section:CreateToggle({Name="Show Distance",Callback=function(s)v[2].ShowDistance=s end,Default=v[2].ShowDistance})end;if v[2].Box~=nil then section:CreateToggle({Name="Show Box",Callback=function(s)v[2].Box=s end,Default=v[2].Box})end end
